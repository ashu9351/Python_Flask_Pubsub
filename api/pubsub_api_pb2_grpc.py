...
def add_PubSubServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Subscribe': grpc.stream_stream_rpc_method_handler(
                    ...
                    response_serializer=FetchResponse.SerializeToString,
            ),
            'GetSchema': grpc.unary_unary_rpc_method_handler(
                    servicer.GetSchema,
                    request_deserializer=SchemaRequest.FromString,
                    response_serializer=SchemaInfo.SerializeToString,
            ),
            'GetTopic': grpc.unary_unary_rpc_method_handler(
                    servicer.GetTopic,
                    request_deserializer=TopicRequest.FromString,
                    response_serializer=TopicInfo.SerializeToString,
            ),
...
class PubSub(object):
    ...
    def GetSchema(request,
            ...
            metadata=None):
                ...
                SchemaRequest.SerializeToString,
                SchemaInfo.FromString,
                options, channel_credentials,
                insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def Publish(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/eventbus.v1.PubSub/Publish',
            PublishRequest.SerializeToString,
            PublishResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
